...
RUN export DPCPP_HOME=/tmp/sycl-compiler &&\
    ...
    cmake $DPCPP_HOME/llvm/llvm -DCMAKE_BUILD_TYPE=Release -DLLVM_TARGETS_TO_BUILD=X86\
          -DLLVM_EXTERNAL_PROJECTS="sycl;llvm-spirv;opencl;sycl-fusion;libdevice;xpti;xptifw"\
          -DLLVM_ENABLE_PROJECTS="clang;sycl;llvm-spirv;opencl;sycl-fusion;libdevice;xpti;xptifw"\
          ...
          -DLLVM_EXTERNAL_SYCL_FUSION_SOURCE_DIR=$DPCPP_HOME/llvm/sycl-fusion\
          ...
          -DLLVM_BUILD_TOOLS=ON -DSYCL_ENABLE_KERNEL_FUSION=ON\
